...
export default function Judge() {
  return (
    <section className="min-h-sceen    py-12 lg:py-10 2xl:py-20 flex flex-col lg:flex-row lg:items-center  lg:-10  relative overflow-hidden  border-b border-b-[#ffffff18] ">
      <div className="bg-ble-500  h-1/2 container mx-auto flex items-center lg:h-full lg:w-1/2 justify-center relative">
        <div
          data-aos="fade-right"
          data-aos-delay="500"
          className=" bg-green300 flex justify-center lg:h-[70vh] w-full pt-10 px-4  "
        >
          <Image
            src={judges}
            width={700}
            ...
            className=" object-center max-lg:w-4/5 h-full place-self-center w-fit inline-block bg-re-300 object-contain "
          />
        </div>
      ...
      <div className="bg-red300 md:px-10 h-1/2 relative mt-4 lg:h-full lg:w-1/2 lg:flex flex-col items-center justify-center pb-10 lg:items-start">
